...
const MyParticipatedMeetings: React.FC = () => {
  ...
  return (
    <div>
      ...
      />
      <ItemContainer>
        {ParticipatedMeetingData.map((participated) => (
          <MeetingListItem
            cover={participated.cover}
            key={participated.id}
            title={participated.title}
            description={participated.description}
            location={participated.location}
            participants={participated.participants}
            maxParticipants={participated.maxParticipants}
            time={participated.time}
            deliveryTime={participated.deliveryTime}
          />
        ))}
      </ItemContainer>
    </div>
